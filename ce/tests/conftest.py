...
polygons = {
    # Metro Van 10 vertex
    'metro_van_10':
            ("POLYGON((-122.70904541015625 49.31438004800689,"
             "-122.92327880859375 49.35733376286064,"
             "-123.14849853515625 49.410973199695846,"
             "-123.34625244140625 49.30721745093609,"
             "-123.36273193359375 49.18170338770662,"
             "-123.20343017578125 49.005447494058096,"
             "-122.44537353515625 49.023461463214126,"
             "-122.46734619140625 49.13500260581219,"
             "-122.50579833984375 49.31079887964633,"
             "-122.70904541015625 49.31438004800689))"),
...
@pytest.fixture(params=polygons.values(), ids=list(polygons.keys()))
def polygon(request):
    return request.param
