...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            "https://marble-dev01.pcic.uvic.ca/twitcher/ows/proxy/thredds/dodsC/datasets/testdata/tasmin_mClim_BNU-ESM_historical_r1i1p1_19650101-19701230_test.nc",
            "tasmin",
        ),
        (
            "ce/tests/data/tasmax_mClim_BNU-ESM_historical_r1i1p1_19650101-19701230.nc",
            "https://marble-dev01.pcic.uvic.ca/twitcher/ows/proxy/thredds/dodsC/datasets/testdata/tasmax_mClim_BNU-ESM_historical_r1i1p1_19650101-19701230_test.nc",
            "tasmax",
        ),
    ],
)
