...
@pytest.mark.parametrize(
    "elevations, areas, exception", (([1, 2], [5, 10, 20], IndexError),)
)
...
def test_computation(elevations, areas, bin_start, bin_width, num_bins, e_cum_areas):
    cumulative_areas = hypsometry(elevations, areas, bin_start, bin_width, num_bins)
